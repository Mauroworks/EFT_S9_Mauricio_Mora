        ...
        do
        {
            ...
            switch(opcion){
                    ...
                    switch(ubicacion)
                    {
                        case 1:
                            ...
                            for(int j=0;j<=cantEntradas-1;j++)
                            {
                                ...
                                }while(asiento<41 || asiento>60  || arrPlatea[asiento-41].equals("V") || error);
                        ...
                        case 2:
                            ...
                            for(int j=0;j<=cantEntradas-1;j++)
                            {
                                ...
                                }while(asiento<211 || asiento>40 || arrPalco[asiento-21].equals("V") || error);
                ...
                case 2:
                    ...
                    }while(id_venta<1 || id_venta>max_id || error);
                ...
                case 3:
                    ...
                    }while(ubicacion<1 || ubicacion>3 || error);
                    do
                    {
                        try{
                            error = false;
					...
					error = true;
                                ...
                                }while(asiento<21 || asiento>40 || arrPalco[asiento-21].equals("V") || error);
                                arrPalco[asiento-21]="V";
                                asientosVenta = asientosVenta + String.valueOf(asiento) + ",";
